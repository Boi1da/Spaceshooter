    ...
    static class Input
    {
        ...
        public static Vector2 GetMovementDirection()
        {
            ...
            if (keyboardState.IsKeyDown(Keys.S))
                direction.Y += 1;
            if (keyboardState.IsKeyDown(Keys.Space) && PlayerShip.Instance.canUseSpecial)
            {
                Console.WriteLine("Input: Special Used!");
                PlayerShip.Instance.useSpecial();
                PlayerShip.Instance.isTimerOn = true;
            }
        ...
        {
            Vector2 direction = PlayerShip.Instance.Position;
